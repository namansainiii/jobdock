                ...
                @csrf
                    ...
                    <div class="mb-4">
                        ...
                        <select id="status" name="status"
                            ...
                            <option value="active" selected>🟢 Active — visible to job seekers</option>
                            <option value="draft">🟡 Draft — hidden, save for later</option>
                        </select>
                        <p class="text-xs text-gray-400 mt-1">You can change this anytime from your dashboard.</p>
                    </div>
