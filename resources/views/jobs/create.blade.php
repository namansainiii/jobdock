<x-layout>
    ...
    <div class="bg-gradient-to-br from-slate-900 via-slate-800 to-zinc-950 py-10 px-4 text-center text-white mb-8">
        ...
        <p class="text-slate-300 text-sm">Fill in the details below to attract the best candidates.</p>
    </div>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="number" name="salary" id="salary" value="{{ old('salary') }}"
                                    ...
                                    class="w-full border border-gray-200 rounded-xl pl-8 pr-4 py-2.5 text-sm focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition-all @error('salary') border-red-400 bg-red-50 @enderror">
                            </div>
                        </div>
                        <div>
                ...
                <div class="p-6 space-y-5">
                    <div>
                        ...
                        <textarea name="description" id="description" rows="6"
                            ...
                            class="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition-all resize-none @error('description') border-red-400 bg-red-50 @enderror">{{ old('description') }}</textarea>
                    </div>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <textarea name="requirements" id="requirements" rows="4"
                                ...
                                class="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition-all resize-none">{{ old('requirements') }}</textarea>
                        </div>
                        <div>
                            ...
                            <textarea name="benefits" id="benefits" rows="4"
                                ...
                                class="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition-all resize-none">{{ old('benefits') }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="p-6 space-y-5">
                    ...
                    <div>
                        ...
                        <textarea name="company_description" id="company_description" rows="3"
                            ...
                            class="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition-all resize-none">{{ old('company_description') }}</textarea>
                    </div>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                        ...
                        <div class="border-2 border-dashed border-gray-200 rounded-xl p-4 flex items-center gap-4 hover:border-amber-300 transition-all">
                            ...
                            <div class="flex-1">
                                <input type="file" name="company_logo" id="company_logo" accept="image/*"
                                    class="block w-full text-sm text-gray-500 file:mr-3 file:py-1.5 file:px-3 file:rounded-lg file:border-0 file:text-xs file:font-semibold file:bg-amber-50 file:text-amber-700 hover:file:bg-amber-100 transition-all">
